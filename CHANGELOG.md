...
* **New Resource**: `r/tfe_project_policy_set` is a new resource to attach/detach an existing `project` to an existing `policy set`. [972](https://github.com/hashicorp/terraform-provider-tfe/pull/972)
