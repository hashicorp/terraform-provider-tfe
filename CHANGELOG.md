...
* **New Data Source**: d/tfe_organization_workspace_tags is a new datasource to allow reading workspace tags within an organization ([#773](https://github.com/hashicorp/terraform-provider-tfe/pull/773))
