...
* `d/tfe_workspace_ids`: `tag_names` has been deprecated in favor of `filter_tags` to query for workspaces by key-value tags.
...
* `d/tfe_project`: Adds the `tags` attribute, by @sebasslash [#1543](https://github.com/hashicorp/terraform-provider-tfe/pull/1543)
* `d/tfe_workspace`: Adds the `tags` attribute which reflects all effective tags computed on the workspace, by @sebasslash [#1543](https://github.com/hashicorp/terraform-provider-tfe/pull/1543)
* `d/tfe_workspace_ids`: Adds the `filter_tags` attribute which filters the list of workspace IDs specified by the `include` or `exclude` fields, by @sebasslash [#1543](https://github.com/hashicorp/terraform-provider-tfe/pull/1543)
