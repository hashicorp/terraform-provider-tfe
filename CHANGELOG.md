...
* **New Data Source:** `d/tfe_scim_groups`: Adds a data source to retrieve SCIM groups from Terraform Enterprise. By @skj-skj [#2083](https://github.com/hashicorp/terraform-provider-tfe/pull/2083)
