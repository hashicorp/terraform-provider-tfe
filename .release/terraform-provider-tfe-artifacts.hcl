...
artifacts {
  ...
  zip = [
    "terraform-provider-tfe_${version}_darwin_amd64.zip",
    "terraform-provider-tfe_${version}_darwin_arm64.zip",
    "terraform-provider-tfe_${version}_freebsd_386.zip",
    "terraform-provider-tfe_${version}_freebsd_amd64.zip",
    "terraform-provider-tfe_${version}_freebsd_arm.zip",
    "terraform-provider-tfe_${version}_linux_386.zip",
