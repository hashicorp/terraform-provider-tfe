...
func resourceTFETeam() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"organization_access": {
				Description: "Settings for the team's [organization access](https://www.terraform.io/docs/cloud/users-teams-organizations/permissions.html#organization-level-permissions).",
			...
			"visibility": {
				Description: "The visibility of the team ('secret' or 'organization'). Defaults to 'secret'.",
				Type:        schema.TypeString,
				Optional:    true,
				Default:     "secret",
			...
			"sso_team_id": {
				Description: "Unique Identifier to control [team membership](https://www.terraform.io/cloud-docs/users-teams-organizations/single-sign-on#team-names-and-sso-team-ids) via SAML. Defaults to `null`",
				Type:        schema.TypeString,
				Optional:    true,
			},
		},
