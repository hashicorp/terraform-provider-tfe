...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tfe_settings_cost_estimation":    resourceTFESettingsCostEstimation(),
			"tfe_settings_customization":      resourceTFESettingsCustomization(),
			"tfe_settings_general":            resourceTFESettingsGeneral(),
			"tfe_settings_saml":               resourceTFESettingsSAML(),
			"tfe_settings_smtp":               resourceTFESettingsSMTP(),
			"tfe_settings_twilio":             resourceTFESettingsTwilio(),
