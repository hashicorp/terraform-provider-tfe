...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"tfe_admin_settings_cost_estimation": resourceTFEAdminSettingsCostEstimation(),
			"tfe_admin_settings_customization":   resourceTFEAdminSettingsCustomization(),
			"tfe_admin_settings_general":         resourceTFEAdminSettingsGeneral(),
			"tfe_admin_settings_saml":            resourceTFEAdminSettingsSAML(),
			"tfe_admin_settings_smtp":            resourceTFEAdminSettingsSMTP(),
			"tfe_admin_settings_twilio":          resourceTFEAdminSettingsTwilio(),
