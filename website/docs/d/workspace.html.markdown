...
* `tags` - A map of key-value tags associated with the workspace.
* `effective_tags` - A map of key value tags associated with the workspace, including inherited tags from the parent project.
