...
#
from imports.tfe. import DataTfeRegistryProviders
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataTfeRegistryProviders(self, "all",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataTfeRegistryProviders(self, "private",
            organization="my-org-name",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataTfeRegistryProviders(self, "hashicorp",
            organization="my-org-name",
            search="hashicorp"
        )
```
