...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        tfe_policy_set_test = tfe.policy_set.PolicySet(self, "test_3",
            agent_enabled=cdktf.Token.as_boolean("true"),
            ...
            workspace_ids=[cdktf.Token.as_string(tfe_workspace_test.id)]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_tfe_slug_test = tfe.data_tfe_slug.DataTfeSlug(self, "test_2",
            source_path="policies/my-policy-set"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_tfe_slug_test.override_logical_id("test")
        tfe_policy_set_test = tfe.policy_set.PolicySet(self, "test_3",
            description="A brand new policy set",
            name="my-policy-set",
            organization="my-org-name",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        tfe_policy_test = tfe.policy.Policy(self, "test",
        ...
        tfe_policy_set_test = tfe.policy_set.PolicySet(self, "test_3",
            ...
            name="my-policy-set",
            organization="my-org-name",
            policy_ids=[cdktf.Token.as_string(tfe_policy_test.id)],
            policy_tool_version="0.24.1",
            workspace_ids=[cdktf.Token.as_string(tfe_workspace_test.id)]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
