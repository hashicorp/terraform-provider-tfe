...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        tfe_organization_run_task_example =
        ...
        tfe.organization_run_task_global_settings.OrganizationRunTaskGlobalSettings(self, "example_1",
            enabled=True,
            enforcement_level="advisory",
            stages=["pre_plan", "post_plan"],
            task_id=cdktf.Token.as_string(tfe_organization_run_task_example.id)
        )
