...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	...
	dataRetentionPolicy.NewDataRetentionPolicy(this, jsii.String("foobar"), map[string]interface{}{
		"deleteOlderThan": []map[string]*f64{
			map[string]*f64{
				"days": jsii.Number(42),
			},
		},
		"workspaceId": cdktf.Token_AsString(tfeWorkspaceTestWorkspace.id),
	})
	return this
}
```
