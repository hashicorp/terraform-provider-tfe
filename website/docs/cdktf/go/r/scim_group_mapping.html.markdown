...
[`TfeScimSettings`](scim_settings.html) for details. The SCIM group you map to
...
mapping is created. Use the [`TfeScimGroup`](../d/scim_group.html) data source
...
* `TeamId` - (Required) The ID of the team to map the SCIM group to. Changing
  this forces a new mapping to be created.
* `ScimGroupId` - (Required) The ID of the SCIM group to map to the team.
...
* `Id` - The ID of the SCIM group mapping. Since a team can only be mapped to one
  SCIM group, this is the same as `TeamId`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5864f09efdaaa9aa81c4d8f46803b1443fa125ba89389897ffa82e215a3df87b -->