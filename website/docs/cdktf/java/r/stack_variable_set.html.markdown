...
* `variableSetId` - (Required) ID of the variable set to add to the stack.
* `stackId` - (Required) ID of the stack to add the variable set to.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1a3ac6fd0ba716bebc3c214a6a957ff191ab8e5fc90592cd65b457f107b47a1e -->