...
import gen.providers.tfe.projectNotificationConfiguration.*;
public class MyConvertedCode extends TerraformStack {
    public MyConvertedCode(Construct scope, String name) {
        ...
        new ProjectNotificationConfiguration(this, "test_2", new ProjectNotificationConfigurationConfig()
                .destinationType("generic")
                .enabled(true)
                .name("my-test-notification-configuration")
                .projectId(Token.asString(tfeProjectTest.getId()))
                .triggers(List.of("run:created", "run:completed"))
