 ...
 */
import { DataTfeOrganizationRunTaskGlobalSettings } from "./.gen/providers/tfe/data-tfe-organization-run-task-global-settings";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataTfeOrganizationRunTaskGlobalSettings(this, "example", {
      taskId: "task-abc123",
    });
  }
}
