 ...
 */
import { Stack } from "./.gen/providers/tfe/";
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new Stack(this, "test-stack", {
      ...
      name: "my-stack",
      project_id: organization.defaultProjectId,
      vcs_repo: [
        {
          branch: "main",
          identifier: "my-github-org/stack-repo",
          oauth_token_id: test.oauthTokenId,
        },
      ],
    });
  }
...
<!-- cache-key: cdktf-0.20.1 input-647b86834df95c1c357e66862aa1ce8a7f6e71374728ea1ad8fd13f979f2709f -->